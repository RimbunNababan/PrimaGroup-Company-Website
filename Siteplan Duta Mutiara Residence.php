...
<html lang="en">
  <head>
    ...
    <title>Siteplan Duta Mutiara Residence</title>
    <link rel="icon" href="assets/prima grup png.png" type="image/png" />
 ...
 body {
  ...
  <body>
  <div class="container">
  <h2 style="text-align: center; margin-top: 90px">
        Siteplan Perumahan Duta Mutiara Residence
      </h2>
...
<div style="margin-top: -160px; text-align: left; margin-left: 10px">
    <h3>Keterangan:</h3>
